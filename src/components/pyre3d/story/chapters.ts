...
const c04: ChapterDef = {
  ...
  world: {
    ...
    terrain: [
      ...
      { t: "ridge", axis: "z", center: -100, halfWidth: 300, feather: 180, height: 18 },
      { t: "ridge", axis: "z", center: 200, halfWidth: 250, feather: 160, height: 14 },
      { t: "flatten", x: 0, z: 0, radius: 160, feather: 80, height: 0 },
    ],
    scatter: {},
    skyColor: 0xd4a86a,
    fogColor: 0xc8a870,
    ...
    props: [
      ...
      { t: "deco", x: -120, z: -350, kind: "rock", scale: 1.5 },
      { t: "deco", x: 130, z: -320, kind: "rock", scale: 2.0 },
      { t: "deco", x: -180, z: -200, kind: "rock", scale: 1.2 },
      { t: "deco", x: 160, z: -150, kind: "rock", scale: 1.8 },
      { t: "deco", x: -140, z: 50, kind: "rock", scale: 1.6 },
      { t: "deco", x: 150, z: 80, kind: "rock", scale: 2.2 },
      { t: "deco", x: -170, z: 200, kind: "rock", scale: 1.4 },
      { t: "deco", x: 140, z: 280, kind: "rock", scale: 1.8 },
      { t: "deco", x: -100, z: -280, kind: "cactus", scale: 1.2 },
      { t: "deco", x: 110, z: -200, kind: "cactus", scale: 0.9 },
      { t: "deco", x: -90, z: 100, kind: "cactus", scale: 1.5 },
      { t: "deco", x: 100, z: 200, kind: "cactus", scale: 1.1 },
      { t: "deco", x: -130, z: 320, kind: "cactus", scale: 1.3 },
      { t: "deco", x: 80, z: -380, kind: "deadtree", scale: 1.0 },
      { t: "deco", x: -80, z: -100, kind: "deadtree", scale: 1.2 },
      { t: "deco", x: 90, z: 150, kind: "deadtree", scale: 0.8 },
      { t: "deco", x: -60, z: 280, kind: "deadtree", scale: 1.1 },
      { t: "deco", x: 60, z: 340, kind: "tent", scale: 1.0 },
      { t: "deco", x: 20, z: 360, kind: "tent", scale: 0.9 },
      { t: "deco", x: -10, z: 380, kind: "tent", scale: 1.1 },
      { t: "deco", x: -25, z: 350, kind: "campfire", scale: 1.0 },
      { t: "deco", x: 40, z: 330, kind: "barrel", scale: 1.0 },
      { t: "deco", x: 55, z: 355, kind: "barrel", scale: 0.8 },
      { t: "deco", x: -200, z: -400, kind: "rock", scale: 3.0 },
      { t: "deco", x: 200, z: -380, kind: "rock", scale: 2.8 },
      { t: "deco", x: -220, z: 300, kind: "rock", scale: 2.5 },
      { t: "deco", x: 210, z: 350, kind: "rock", scale: 2.2 },
      { t: "deco", x: -50, z: -440, kind: "deadtree", scale: 1.3 },
      { t: "deco", x: 70, z: 440, kind: "cactus", scale: 1.4 },
    ],
    airships: [
